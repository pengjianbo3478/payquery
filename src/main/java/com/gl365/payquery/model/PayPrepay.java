...
public class PayPrepay implements Serializable, Cloneable {
	...
	*4：网购订单
	...
	/**
	 * 发展商户机构
	 * @param merchantAgentNo the merchantAgentNo to set
	 */
	 ...
	 * <p>1-代理商 2-商家</p>
	 * 发展会员机构
	 * @param userAgentNo the userAgentNo to set
	 */
	...
	/**
	 * 订单描述
	 * @param merchentOrderDesc the merchentOrderDesc to set
	 */
	...
	/**
	 * 乐豆金额
	 * @param beanAmount the beanAmount to set
	 */
	...
	/**
	 * 支付手续费上限值
	 * @param maxPayFee the maxPayFee to set
	 */
	...
	/**
	 * 营销费
	 * @param marcketFee the marcketFee to set
	 */
	...
	/**
	 * 返利率
	 * @param giftRate the giftRate to set
	 */
	...
	/**
	 * 赠送积分
	 * @param giftPoint the giftPoint to set
	 */
	...
	/**
	 * 商户实得金额
	 * @param merchantSettleAmount the merchantSettleAmount to set
	 */
